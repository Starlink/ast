...
\item The Mapping class has a new attribute called ``Protect'' that can be used
to prevent individual Mappings being affected by the
c+
astSimplify
c-
f+
