...
/* Forward declarations for IsA<Class> functions generated by MAKE_TEST below */
static int IsASpherical_Cartesian( const char *, int * );
...
/* Do the appropriate test */
      if( !strncmp( km_class, "gwcs/", 5 ) ){
         ...
         } else if( !strcmp( "spherical_cartesian", class ) || !strcmp( "transform", class ) ){
...
MAKE_TEST(Spherical_Cartesian,gwcs,1,1)
